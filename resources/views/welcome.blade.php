                        ...
                        <div class="row fullscreen justify-content-center align-items-center">
                            <div class="col-md-10 col-12">
                                <div class="banner-content text-center">
                                    <h4 class="text-white mb-20 text-uppercase">Welcome to</h4>
                                    <h1 class="text-uppercase text-white">IIUM</h1>
                                    ...
                                    <a href="#" class="text-uppercase header-btn">TAKE A TOUR</a>
                                </div>
                            </div>
                ...
                <div class="item-slider relative" style="background: url(img/slider2.jpg);background-size: cover;">
                    ...
                    <div class="container">
                        <div class="row fullscreen justify-content-center align-items-center">
                            <div class="col-md-10 col-12">
                                <div class="banner-content text-center">
                                    <h4 class="text-white mb-20 text-uppercase">Explore IIUM Like Never Before</h4>
                                    <p class="text-white">Discover the beauty and history of the International Islamic University Malaysia
                                        with our interactive Campus Tour Guide System. Whether you're a student, staff, or visitor,
                                        embark on a journey through landmarks, book guided tours, and stay informed about campus events, all at your fingertips!</p>
                                    <a href="#" class="text-uppercase header-btn">BOOK YOUR TOUR GUIDE NOW</a>
                                </div>
                            </div>
                        </div>
                    </div>
